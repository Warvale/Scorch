...
public class GuildCommand extends AbstractCommand{
    ...
    private void sendUsageMessage(Player player){
        ...
        player.sendMessage(ChatColor.RED + "/guild transferownership <player>" + ChatColor.DARK_RED + " - " + ChatColor.GOLD + "Transfer the ownership of a guild to another player in the guild (Can not be undone unless the new owner does " + ChatColor.RED + "/guild transferownership " + ChatColor.RED + player.getName() + ChatColor.GOLD + "!)");
